...
class FormFieldFactory implements iFactory
{
    public function createItem(array $field_info): iView
    {
        ...
        {
            case 'text':
                return new Textfield($field_info['name'], $field_info['label'], $field_info['placeholder'] ?? '');
            
            case 'textarea':
                return new TextArea($field_info['name'], $field_info['label'], $field_info['placeholder'] ?? '');
